...
const CollapseSimulationDetails: React.FC<SimulationDetailsProps> = ({ simulationData }) => {
  ...
  if (!data) {
    return (
      <Box p={4}>
        ...
        <Button onClick={() => navigate('/colapso/simulacion')} mt={4}>
          Volver
        </Button>
      </Box>
    );
...
export default CollapseSimulationDetails; 